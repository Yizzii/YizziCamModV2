...
namespace YizziCamModV2
{
    ...
    public class Main : BaseUnityPlugin
    {
        ...
        public void YizziStart()
        {
            ...
            Buttons.AddUnique(GameObject.Find("CameraTablet(Clone)/MiscPage/SpeedDownButton"));
            Buttons.AddUnique(GameObject.Find("CameraTablet(Clone)/MiscPage/TPModeDownButton"));
            Buttons.AddUnique(GameObject.Find("CameraTablet(Clone)/MiscPage/TPModeUpButton"));
            Buttons.AddUnique(GameObject.Find("CameraTablet(Clone)/MiscPage/TPRotButton"));
            Buttons.AddUnique(GameObject.Find("CameraTablet(Clone)/MiscPage/TPRotButton1"));
